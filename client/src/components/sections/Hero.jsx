  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 via-gray-100 to-blue-200 bg-no-repeat overflow-hidden relative py-6">
      ...
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-6 sm:gap-8 px-4 sm:px-6 py-6 sm:py-8 md:grid-cols-2 lg:px-8 relative z-10">
        <div className="space-y-5 sm:space-y-6">
          ...
          <div className="flex flex-wrap gap-6">
            <button
              ...
              className="group relative px-4 sm:px-6 py-2 sm:py-3 text-base sm:text-lg font-semibold text-white overflow-hidden rounded-xl bg-[#1CDAFF] transition-all duration-300 ease-out hover:scale-105 hover:shadow-[0_0_40px_8px_rgba(28,218,255,0.3)] focus:outline-none focus:ring-2 focus:ring-[#1CDAFF] focus:ring-offset-2 focus:ring-offset-blue-900"
            >
        ...
        <div className="relative flex min-h-[16rem] sm:min-h-[18.75rem] items-center justify-center lg:min-h-[35rem]">
          <div className="relative size-48 sm:size-56 md:size-[20rem] lg:size-[25.75rem]">
            <img
              src={imageUrl}
